                        ...
                        if(app.status != 1) {
                            ...
                            $('#button-accept'+ app.id +'').click(function (e) { 
                                ...
                                if(res) {
                                    ...
                                    $.ajax({
                                        type: "put",
                                        url: "http://jobboard.com/api/applications/" + app.id,
                                        data: JSON.stringify(data),
                                        success: function (response) {
                                            alert(response);
                                            window.location.replace("http://jobboard.com/company/pendind-requests.html");
                                        },
